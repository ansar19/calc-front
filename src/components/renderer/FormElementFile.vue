    ...
    <div class="col-sm-9 text-left">
      <div v-if="value">
        ...
        <div class="w-100 mt-2 mb-2" v-if="!read_only">
          <button type="button" class="replace btn btn-secondary col-sm-2" href=""
            v-on:click.prevent="$set(flags, 'replace', true)">Replace</button>
          <button type="button" class="delete btn btn-secondary col-sm-2" href=""
            v-on:click.prevent="clearValue()">Delete</button>
        </div>
      </div>
